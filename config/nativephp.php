...
return [
     ...
     */
    'version' => env('NATIVEPHP_APP_VERSION', '0.5.2'),
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'dev.orbit.desktop'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Your local developer workspace'),
