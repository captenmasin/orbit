...
const props = defineProps<{ index: number, mask?: boolean, class?: HTMLAttributes['class'] }>()

const delegatedProps = reactiveOmit(props, 'class', 'mask')
...
<template>
  ...
  >
    {{ props.mask && slot?.char ? '•' : slot?.char }}
